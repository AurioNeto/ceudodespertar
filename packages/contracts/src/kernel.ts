...
export type ImportacaoId = Brand<string, 'ImportacaoId'>;
export type LinhaExtratoId = Brand<string, 'LinhaExtratoId'>;
...
export type DormitorioId = Brand<string, 'DormitorioId'>;
export type LeitoId = Brand<string, 'LeitoId'>;
...
export type FeitioId = Brand<string, 'FeitioId'>;
